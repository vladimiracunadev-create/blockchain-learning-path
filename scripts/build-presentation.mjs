...
<section class="slide${s.n === 1 ? " portada" : ""}">
  ...
  <div class="pie"><span>v${version} · 28 módulos · 70 prácticas</span><span>${SITE.replace("https://", "")}</span></div>
</section>`;
}).join("\n");
...
<div class="portada">
  ...
  <p>28 módulos · 70 prácticas · de cero a la infraestructura financiera</p>
