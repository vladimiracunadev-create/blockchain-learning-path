...
if (modules.length < 19 || modules.some((module) => module.status !== "completed" || module.score < 80)) {
  throw new Error("Se requieren 19 módulos completados con nota mínima de 80");
}
...
Se deja constancia de que **${progress.student}** registró la finalización de los 19 módulos y del proyecto final de Blockchain Learning Path.

- Perfil: ${progress.profile}
- Proyecto: ${progress.capstone.title}
- Evidencias: 19 módulos y 50 prácticas
