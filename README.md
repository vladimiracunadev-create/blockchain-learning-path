...
El ledger dice qué reconoce la empresa; el export de un exchange dice qué reconoce un tercero; la cadena muestra estado de direcciones y contratos. El trabajo profesional consiste en probar cómo se relacionan, con el mismo activo y corte, sin confundir ninguno con una auditoría completa.
...
Luego empieza por [curriculum/00-orientacion](curriculum/00-orientacion/README.md). Cada una de las 91 prácticas trae su **resolución explicada** —cómo se implementa, el comando, la salida esperada y su interpretación— en el [cuaderno de laboratorios](labs/guides/README.md).
