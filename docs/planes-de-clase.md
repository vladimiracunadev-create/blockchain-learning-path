...
Planes listos para instructores. Cada unidad contiene **dos clases de 90
minutos** más trabajo autónomo. Este documento ofrece una plantilla de sesión, el mapa
de clases por unidad y planes completos de ejemplo con su minutaje. Ver también el
...
## Mapa de las 66 clases

| Unidad | Clase A | Clase B | Reto | Error que debe detectar |
|---:|---|---|---|---|
