...
```mermaid
flowchart LR
    A["🏗️ 01<br>Cómo se construye"] --> B["🧰 02<br>Stack tecnológico"]
    B --> C["👥 03<br>Equipos y metodología"]
    C --> D["🏢 04<br>Blockchain para empresas"]
    D --> E["💼 05<br>Modelos de negocio"]
    E --> F["🔄 06<br>Ciclo de vida"]
    A -.-> T["Tecnología"]
    B -.-> T
    C -.-> O["Organización"]
    D -.-> N["Negocio"]
